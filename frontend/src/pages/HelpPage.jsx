...
const FAQS = [
  ...
  { q: 'Can I cancel my order?',
    a: 'Yes, you can cancel an order as long as it is in PLACED or PREPARING status. Once it is marked READY, cancellation is not possible.' },
  { q: 'How do I track my order?',
    a: "After placing an order, go to \"My Orders\". You'll see a real-time progress bar — Placed → Preparing → Ready → Delivered. You also get email updates at every stage." },
